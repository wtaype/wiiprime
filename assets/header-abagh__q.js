const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/wiauth-ElkysLuY.js","assets/main-D_U820IC.js","assets/vendor-B2AETYxa.js","assets/init-D7ituNmG.js","assets/firebase-BDBD3npj.js"])))=>i.map(i=>d[i]);
import{M as _,$ as t,r as l,g as p,_ as n,l as e,m as g}from"./main-D_U820IC.js";import"./vendor-B2AETYxa.js";g({js:[()=>n(()=>import("./wiauth-ElkysLuY.js"),__vite__mapDeps([0,1,2,3,4]))]});function b(a){_?.("Bienvenido "+a.nombre),t(".wiauth").html(`
