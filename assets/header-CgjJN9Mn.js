const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/wiauth-BxtU2u8V.js","assets/main-Br5QSZku.js","assets/vendor-B2AETYxa.js","assets/init-D7ituNmG.js","assets/firebase-BDBD3npj.js"])))=>i.map(i=>d[i]);
import{M as _,$ as t,r as l,g as p,_ as n,l as e,m as g}from"./main-Br5QSZku.js";import"./vendor-B2AETYxa.js";g({js:[()=>n(()=>import("./wiauth-BxtU2u8V.js"),__vite__mapDeps([0,1,2,3,4]))]});function d(a){_?.("Bienvenido "+a.nombre),t(".wiauth").html(`
