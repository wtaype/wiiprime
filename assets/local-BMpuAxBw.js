import{k as n,$ as i,j as f,r as l,N as m,w as v}from"./main-Dyduod8k.js";import"./vendor-B2AETYxa.js";const c=(o,t)=>`
...
`,b=async()=>{const o=[["🌍","Ciudad","infoCiudad","--mco"],["📍","IP Pública","infoIp","--mco"],["💻","Navegador","infoBrowser","--mco"],["🖥️","Sistema Operativo","infoOs","--mco"],["📱","Dispositivo","infoDevice","--mco"],["🌐","Zona Horaria","infoTimezone","--mco"]],t=[["🏙️","Ciudad","infoCity","--success"],["📍","Región","infoRegion","--success"],["🌎","País","infoCountry","--success"],["📮","Código Postal","infoPostal","--success"],["🗺️","Latitud","infoLat","--success"],["🗺️","Longitud","infoLng","--success"]],e=[["🖥️","Pantalla","infoScreen","--info"],["📐","Viewport","infoViewport","--info"],["🌐","Idioma","infoLanguage","--info"],["⏰","Hora Local","infoTime","--info"],["🌍","UTC Offset","infoUtc","--info"],["📡","Estado","infoOnline","--info"]],r=[["📋 Copiar IP","btnCopyIp","--mco"],["📍 Copiar Ciudad","btnCopyCiudad","--success"],["📊 Mostrar Todo","btnMostrarTodo","--info"],["🔄 Actualizar","btnLimpiarCache","--warning"]];return`
  ...
  `},u=async()=>{n(o=>{i("#infoCiudad").text(`${o.city}, ${o.country}`),i("#infoIp").text(o.ip),i("#infoBrowser").text(o.browser),i("#infoOs").text(o.os),i("#infoDevice").text(o.device),i("#infoTimezone").text(o.timezone),i("#infoCity").text(o.city),i("#infoRegion").text(o.region),i("#infoCountry").text(o.country),i("#infoPostal").text(o.postal||"N/A"),i("#infoLat").text(o.lat.toFixed(4)),i("#infoLng").text(o.lng.toFixed(4)),i("#infoScreen").text(o.screen),i("#infoViewport").text(o.viewport),i("#infoLanguage").text(o.language),i("#infoTime").text(o.time),i("#infoUtc").text(`UTC${o.utcOffset>=0?"+":""}${o.utcOffset}`),i("#infoOnline").text(o.online?"✅ Online":"❌ Offline"),i("#jsonData").text(JSON.stringify(o,null,2))}),i("#btnCopyIp").on("click",function(){f(n("ip"),this,"¡IP copiada!")}),i("#btnCopyCiudad").on("click",function(){f(n("ciudad"),this,"¡Ciudad copiada!")}),i("#btnMostrarTodo").on("click",function(){n(o=>{console.table(o),m("Datos en consola","info"),v(this,"Ver consola (F12)","info",2e3)})}),i("#btnLimpiarCache").on("click",function(){l("wiIp"),location.reload()})};export{u as init,b as render};
