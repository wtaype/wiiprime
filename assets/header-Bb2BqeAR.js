const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/wiauth-CHyMw44K.js","assets/main-DX3Uq-7_.js","assets/vendor-B2AETYxa.js","assets/init-BktE2GIV.js","assets/firebase-KckUx_OB.js"])))=>i.map(i=>d[i]);
import{M as _,$ as i,g as c,_ as n,r as e,w as p}from"./main-DX3Uq-7_.js";import"./vendor-B2AETYxa.js";p({js:[()=>n(()=>import("./wiauth-CHyMw44K.js"),__vite__mapDeps([0,1,2,3,4]))]});function b(a){_?.("Bienvenido "+a.nombre),i(".wiauth").html(`
    <div class="sesion">
