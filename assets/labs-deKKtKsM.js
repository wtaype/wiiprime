import{a as v,$ as e,i as w,e as m}from"./main-CW815Ov8.js";import"./vendor-B2AETYxa.js";import"./firebase-DWujM1-5.js";let n=[];const f=()=>{let s="";for(let a=0;a<60;a++){const i=a*6,o=a%5===0?"wihora_mark wihora_mark_hour":"wihora_mark wihora_mark_minute";s+=`<div class="${o}" style="transform: rotate(${i}deg) translateY(-50px)"></div>`}return s},d=(s,a)=>{const i=w(s.zona);if(!i)return;const[r,o,t]=i.hora.split(":").map(Number),c=m(i.hora);a.removeClass("es-dia es-noche").addClass(c?"es-dia":"es-noche");const h=t*6,l=o*6+t*.1,_=r%12*30+o*.5;a.find(".wihora_hand_second").css("transform",`translateX(-50%) rotate(${h}deg)`),a.find(".wihora_hand_minute").css("transform",`translateX(-50%) rotate(${l}deg)`),a.find(".wihora_hand_hour").css("transform",`translateX(-50%) rotate(${_}deg)`),a.find(".wihora_time").text(i.hora),a.find(".wihora_fecha").text(i.fecha),a.find(".wihora_gmt").text(i.gmt),a.find(".wihora_estacion").text(i.estacion),a.find(".wihora_icon i").attr("class",`fas ${c?"fa-sun":"fa-moon"}`)},k=async()=>{const s=[{ciudad:"Lima",pais:"Perú",zona:"America/Lima",codigo:"pe"},{ciudad:"Tokio",pais:"Japón",zona:"Asia/Tokyo",codigo:"jp"}],a=f();return`
    <div class="wihora">
      ${s.map(i=>`
  ...
  `},z=()=>{n.forEach(clearInterval),n=[];const s=[{zona:"America/Lima"},{zona:"Asia/Tokyo"}];e(".wihora_card").each((a,i)=>{const r=e(i),o=s[a];d(o,r);const t=setInterval(()=>d(o,r),1e3);n.push(t)})},j=()=>{n.forEach(clearInterval),n=[]};export{j as cleanup,z as init,k as render};
