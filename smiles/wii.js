...
export let version = 'v37';

/** ACTUALIZACIÓN PRINCIPAL ONE DEV [START](1)
git add . ; git commit -m "Actualizacion Principal v37.10.10" ; git push origin main

// Actualizar main luego esto, pero si es mucho, solo esto.(2)
git tag v37 -m "Version v37" ; git push origin v37

// En caso de emergencia, para actualizar el Tag existente. (3)
git tag -d v37 ; git tag v37 -m "Version v37 actualizada" ; git push origin v37 --force
