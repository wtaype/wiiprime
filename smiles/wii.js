...
export let version = 'v39';

/** ACTUALIZACIÓN PRINCIPAL ONE DEV [START](1)
git add . ; git commit -m "Actualizacion Principal v39.10.10" ; git push origin main

// Actualizar main luego esto, pero si es mucho, solo esto.(2)
git tag v39 -m "Version v39" ; git push origin v39

// En caso de emergencia, para actualizar el Tag existente. (3)
git tag -d v39 ; git tag v39 -m "Version v39 actualizada" ; git push origin v37 --force
