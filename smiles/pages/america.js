...
let ciudadesFiltradas = [...wiCiudades.america];
...
export const init = () => {
  ...
  $('#searchAmerica').on('input', function() {
    ...
    ciudadesFiltradas = termino ? buscarCiudad(termino, 'america') : [...wiCiudades.america];
    paginaActual = 1;
  ...
  console.log('🌏 America inicializado con relojes analógicos');
};
