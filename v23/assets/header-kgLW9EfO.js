const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/wiauth-D-AVeSQh.js","assets/main-B0wMWafT.js","assets/vendor-B2AETYxa.js","assets/init-DFkVhPiR.js","assets/firebase-D8uqL1sE.js"])))=>i.map(i=>d[i]);
import{M as _,$ as t,r as l,g as p,_ as n,j as e,k as g}from"./main-B0wMWafT.js";import"./vendor-B2AETYxa.js";g({js:[()=>n(()=>import("./wiauth-D-AVeSQh.js"),__vite__mapDeps([0,1,2,3,4]))]});function b(a){_?.("Bienvenido "+a.nombre),t(".wiauth").html(`
