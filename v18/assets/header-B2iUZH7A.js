const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/wiauth-hDxcK_ZG.js","assets/main-DxIGPL7J.js","assets/vendor-B2AETYxa.js","assets/main-BRyAGjpW.css","assets/init-BktE2GIV.js","assets/firebase-KckUx_OB.js"])))=>i.map(i=>d[i]);
import{M as _,$ as i,g as c,_ as n,r as e,w as p}from"./main-DxIGPL7J.js";import"./vendor-B2AETYxa.js";p({js:[()=>n(()=>import("./wiauth-hDxcK_ZG.js"),__vite__mapDeps([0,1,2,3,4,5]))]});function b(a){_?.("Bienvenido "+a.nombre),i(".wiauth").html(`
    <div class="sesion">
