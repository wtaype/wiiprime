...
const htmlMod = {
  ...
  registro: crearModal('registroModal', 'Crear Cuenta',
    ...
    '<button type="button" id="Registrar" class="btnAuth inactivo">Registrarme</button><div class="links"><span class="conCuenta">Ya tengo cuenta</span></div>').replace('authMod', 'authMod regMod'),
